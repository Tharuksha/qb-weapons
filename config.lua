...
--NEW ADDED
Config.UnlimitedReload = false -- Set to true to limit the amount ammo that can be loaded into firearms.
Config.smgMaxAmmo = 150 --sets max ammo for smgs (Each Reload will add 20 ammo)
Config.pistolMaxAmmo = 150 -- sets max ammo for pistols (Each Reload will add 12 ammo)
Config.rifleMaxAmmo = 150 -- sets max ammo for rifles (Each Reload will add 30 ammo)
Config.shotgunMaxAmmo = 150 -- sets max ammo for shotguns (Each Reload will add 10 ammo)
Config.mgMaxAmmo = 30 -- sets max ammo for mgs (Each Reload will add 30 ammo)
Config.sniperMaxAmmo = 150 -- sets max ammo for snipers (Each Reload will add 10 ammo)
